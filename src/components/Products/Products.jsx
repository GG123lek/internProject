...
const ProductsData = [
  { id: 1, img: Img1, title: "Casual Wear", description: "Beautiful Great shirt for men", topRated: true, trending: true, mensWear: true, bestSelling: true },
  { id: 2, img: Img2, title: "Printed Shirt", description: "A nice well-designed shirt for men", topRated: false, mensWear: true, bestSelling: false },
  { id: 3, img: Img3, title: "Women Shirt", description: "Cute lovely shirt for men", topRated: true, trending: true, mensWear: false, bestSelling: false },
  { id: 4, img: Img4, title: "Grey Wear", description: "Beautiful Great shirt for men", topRated: false, mensWear: true, bestSelling: true },
  { id: 5, img: Img5, title: "A Fine Red Wear", description: "A nice well-designed shirt for men", topRated: true, trending: true, mensWear: true, bestSelling: true },
  { id: 6, img: Img6, title: "Button Stripe Wear", description: "Cute lovely shirt for men", topRated: false, mensWear: true, bestSelling: false },
  { id: 7, img: Img7, title: "Cute Kids Wear", description: "Cute lovely shirt for kids", topRated: false, kidsWear: true, bestSelling: false },
  { id: 8, img: Img8, title: "Well Designed Kid Wear", description: "A simple wear for kids", topRated: false, kidsWear: true, bestSelling: true },
  { id: 9, img: Img9, title: "A Casual Kid Wear", description: "Lovely casual wear for kids", topRated: true, trending: true, kidsWear: true, bestSelling: true },
  { id: 10, img: Img10, title: "WristWatch", description: "Latest watches with advanced features", topRated: true, electronics: true, bestSelling: true },
  { id: 11, img: Img11, title: "Headphone", description: "Powerful headphone for work and gaming", topRated: true, electronics: true, bestSelling: false },
  { id: 12, img: Img12, title: "Wireless Phones", description: "Noise-canceling high-quality sound", topRated: false, electronics: true, bestSelling: true },
  { id: 13, img: Img13, title: "Charger", description: "Fast and affordable charger", topRated: false, electronics: true, bestSelling: false },
  { id: 14, img: Img14, title: "Speaker", description: "Best soundbeat u can get", topRated: false, electronics: true, bestSelling: true },
  { id: 15, img: Img15, title: "PowerBank", description: "Get the best charging experience ever", topRated: false, electronics: true, bestSelling: true },
  { id: 16, img: Img16, title: "LaptopCharger", description: "Very fast laptop charger", topRated: false, electronics: true, bestSelling: false },
  { id: 17, img: Img17, title: "Airpod", description: "Small and very lovely listening devices", topRated: false, electronics: true, bestSelling: true },
];
